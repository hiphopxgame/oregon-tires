...
-- Drop all existing policies for por_eve_profiles
...
DROP POLICY IF EXISTS "Users can create their own profile" ON public.por_eve_profiles;
DROP POLICY IF EXISTS "Users can create their own portland-events profile" ON public.por_eve_profiles;
DROP POLICY IF EXISTS "Users can update their own profile" ON public.por_eve_profiles;
DROP POLICY IF EXISTS "Users can update their own portland-events profile" ON public.por_eve_profiles;
DROP POLICY IF EXISTS "Super admin can manage all por_eve_profiles" ON public.por_eve_profiles;
...
-- Users can create their own portland-events profile
...
-- Users can update their own portland-events profile
