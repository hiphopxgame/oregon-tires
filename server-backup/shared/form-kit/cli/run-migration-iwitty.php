<?php
/**
 * Run Form Kit migration for iWitty.Party (HHW database).
 * Run on server: php /home/hiphopwo/shared/form-kit/cli/run-migration-iwitty.php
 *
 * Uses HHW database with NO prefix (site_key handles multi-tenancy).
 */
...
// Load HHW .env
$dotenvPath = '/home/hiphopwo/public_html/.env';
...
echo "Running Form Kit migration for iWitty.Party (no prefix)\n";
echo "Database: {$name}\n\n";
