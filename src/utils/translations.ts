...
const translations = {
  english: {
    ...
    admin: {
      ...
      noAppointmentsScheduled: "No appointments",
      ...
      scheduleNeeded: "Schedule Needed",
      cancel: "Cancel",
  ...
  spanish: {
    ...
    admin: {
      ...
      shopService: "Servicio en Taller",
      tireSize: "Tamaño de Llanta",
      ...
      noAppointmentsScheduled: "Sin citas",
      ...
      scheduleNeeded: "Horario Necesario",
      cancel: "Cancelar",
