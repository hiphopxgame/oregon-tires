...
$serviceIcon = '&#x2699;';
$serviceDescription = 'Computerized wheel alignment for all vehicles in Portland, OR. Corrects camber, caster, and toe for even tire wear and straight driving. Starting at $75. Bilingual service.';
$serviceDescriptionEs = 'Alineacion de ruedas computarizada para todos los vehiculos en Portland, OR. Corrige camber, caster y convergencia para desgaste uniforme y conduccion recta. Desde $75. Servicio bilingue.';
$startingPrice = '$75+';
