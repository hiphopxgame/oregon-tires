...
(function() {
  ...
  var DEV_CONFIRMED = [
    ...
    'acct-paypal',          // PayPal Business connected (live mode, credentials in .env)
  ];
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          detail: {
            en: '\u2705 COMPLETED\n\nPayPal Business is connected in live mode.\nCredentials are configured in the server environment.\n\nPowers:\n\u2022 Care plan subscription billing\n\u2022 Online payments and checkout\n\nTo view transactions: Click the PayPal Dashboard link below.',
            es: '\u2705 COMPLETADO\n\nPayPal Business est\u00e1 conectado en modo live.\nLas credenciales est\u00e1n configuradas en el entorno del servidor.\n\nFunciones:\n\u2022 Facturaci\u00f3n de suscripciones de planes de cuidado\n\u2022 Pagos en l\u00ednea y checkout\n\nPara ver transacciones: Haga clic en el enlace del Panel de PayPal abajo.'
          },
          links: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          detail: {
            en: '\u23F3 IN PROGRESS\n\nStatus: GBP listing is claimed by oregontires1@gmail.com (Primary Owner)\nThe oregontirespdx@gmail.com account can edit the profile but cannot manage People.\n\n━━━ STEPS (sign in as oregontires1@gmail.com) ━━━\n1. Go to Google Search and search "Oregon Tires Auto Care"\n2. Click your business listing \u2192 three dots menu \u2192 "Business Profile settings"\n3. Under "People and access", add these two:\n\n   a) oregontirespdx@gmail.com \u2192 role: Owner\n      (This gives your main business Gmail full control)\n\n   b) oregon-tires@oregon-tires.iam.gserviceaccount.com \u2192 role: Manager\n      (This lets the website sync hours, post updates, track insights)\n\n4. After adding both, share the GBP Account ID and Location ID with your developer\n\nOnce connected, your website can:\n\u2022 Auto-update business hours on Google\n\u2022 Post promotions directly to your Google listing\n\u2022 Track how customers find you (search, maps, direct)',
            es: '\u23F3 EN PROGRESO\n\nEstado: El listado GBP es propiedad de oregontires1@gmail.com (Propietario Principal)\nLa cuenta oregontirespdx@gmail.com puede editar el perfil pero no puede gestionar Personas.\n\n━━━ PASOS (inicie sesi\u00f3n como oregontires1@gmail.com) ━━━\n1. Vaya a Google Search y busque "Oregon Tires Auto Care"\n2. Haga clic en su listado \u2192 men\u00fa de tres puntos \u2192 "Business Profile settings"\n3. En "People and access", agregue estos dos:\n\n   a) oregontirespdx@gmail.com \u2192 rol: Owner\n      (Esto da control total a su Gmail principal del negocio)\n\n   b) oregon-tires@oregon-tires.iam.gserviceaccount.com \u2192 rol: Manager\n      (Esto permite al sitio web sincronizar horarios, publicar, rastrear estad\u00edsticas)\n\n4. Despu\u00e9s de agregar ambos, comparta el Account ID y Location ID de GBP con su desarrollador\n\nUna vez conectado, su sitio web puede:\n\u2022 Actualizar autom\u00e1ticamente los horarios en Google\n\u2022 Publicar promociones directamente en su listado\n\u2022 Rastrear c\u00f3mo los clientes lo encuentran (b\u00fasqueda, mapas, directo)'
          },
          links: [
