    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          detail: {
            en: '\u2705 COMPLETED\n\nVerification: DNS TXT record + HTML meta tag deployed\nTXT Record: google-site-verification=OZB0N6qKUPTNjX8uBqnTY6X0L7pgxSK4zogiUs5yeu0\nMeta Tag: On all pages via includes/gtag.php\nDNS Provider: Porkbun (API-managed)\n\nTo complete verification in Google Search Console:\n1. Go to Search Console (link below)\n2. Sign in with oregontirespdx@gmail.com\n3. Add property \u2192 URL prefix \u2192 https://oregon.tires\n4. Verification should auto-pass (TXT record is live)\n\n━━━ SEO STATUS ━━━\n\u2022 Sitemap: Active at /api/sitemap.php\n\u2022 IndexNow (Bing): Configured for fast indexing\n\u2022 Meta tags: Per-page SEO config on all 36+ pages\n\u2022 JSON-LD: AutomotiveBusiness schema on homepage\n\u2022 Regional SEO: 8 Portland neighborhood pages\n\u2022 Google Analytics: G-PCK6ZYFHQ0 tracking all pages',
            es: '\u2705 COMPLETADO\n\nVerificaci\u00f3n: Registro DNS TXT + meta tag HTML desplegados\nRegistro TXT: google-site-verification=OZB0N6qKUPTNjX8uBqnTY6X0L7pgxSK4zogiUs5yeu0\nMeta Tag: En todas las p\u00e1ginas v\u00eda includes/gtag.php\nProveedor DNS: Porkbun (gestionado por API)\n\nPara completar la verificaci\u00f3n en Google Search Console:\n1. Vaya a Search Console (enlace abajo)\n2. Inicie sesi\u00f3n con oregontirespdx@gmail.com\n3. Agregar propiedad \u2192 URL prefix \u2192 https://oregon.tires\n4. La verificaci\u00f3n deber\u00eda pasar autom\u00e1ticamente (el registro TXT est\u00e1 activo)\n\n━━━ ESTADO SEO ━━━\n\u2022 Sitemap: Activo en /api/sitemap.php\n\u2022 IndexNow (Bing): Configurado para indexaci\u00f3n r\u00e1pida\n\u2022 Meta tags: Configuraci\u00f3n SEO por p\u00e1gina en las 36+ p\u00e1ginas\n\u2022 JSON-LD: Esquema AutomotiveBusiness en la p\u00e1gina principal\n\u2022 SEO Regional: 8 p\u00e1ginas de vecindarios de Portland\n\u2022 Google Analytics: G-PCK6ZYFHQ0 rastreando todas las p\u00e1ginas'
          },
          links: [
