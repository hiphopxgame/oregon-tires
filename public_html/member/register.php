<?php
/**
 * Oregon Tires — Member Registration Page
 *
 * Thin wrapper around member-kit's register template with Oregon Tires branding.
 */
...
$_siteTitle = 'Create Account — Oregon Tires Auto Care';
...
<head>
    ...
    <meta name="description" content="Create your Oregon Tires Auto Care account">
...
<body>
    ...
    include MEMBER_KIT_PATH . '/templates/member/register.php';
