<?php
/**
 * Oregon Tires — Reset Password Page
 *
 * Thin wrapper around member-kit's reset-password template with Oregon Tires branding.
 * Template reads $_GET['token'] itself.
 */
...
$_siteTitle = 'Set New Password — Oregon Tires Auto Care';
...
<head>
    ...
    <meta name="description" content="Set a new password for your Oregon Tires Auto Care account">
...
<body>
    ...
    include MEMBER_KIT_PATH . '/templates/member/reset-password.php';
