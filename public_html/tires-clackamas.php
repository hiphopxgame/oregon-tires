...
$landmarks = [
  ['name' => 'Clackamas Town Center', 'distance' => '8 min drive'],
  ['name' => 'Clackamas Promenade', 'distance' => '10 min drive'],
  ['name' => 'I-205 / Sunnyside Rd exit', 'distance' => '7 min drive'],
];
$testimonial = ['name' => 'David Miller', 'text' => 'Oregon Tires always takes care of my family\'s vehicles. Honest, reliable service. Worth the drive from Clackamas every time.'];
$nearbyAreas = [
