...
function memberT(string $key, string $lang = ''): string
{
    ...
    static $strings = [
        ...
        'first_name_label'      => ['en' => 'First Name', 'es' => 'Nombre'],
        'last_name_label'       => ['en' => 'Last Name', 'es' => 'Apellido'],
        'first_name_placeholder' => ['en' => 'First name', 'es' => 'Nombre'],
        'last_name_placeholder'  => ['en' => 'Last name', 'es' => 'Apellido'],
