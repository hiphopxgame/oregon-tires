...
/**
 * Oregon Tires — Commerce Checkout Return API
 * Thin wrapper around commerce-kit checkout-return endpoint.
...
require $commerceKitPath . '/api/commerce/checkout-return.php';
